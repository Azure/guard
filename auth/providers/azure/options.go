...
func (o *Options) AddFlags(fs *pflag.FlagSet) {
	...
	fs.BoolVar(&o.EnableSPGroupResolution, "azure.enable-sp-group-resolution", true, "when set to true, group membership of service principal (application) tokens is resolved via the servicePrincipals graph endpoint. when false, service principal tokens carrying an overage claim are rejected")
